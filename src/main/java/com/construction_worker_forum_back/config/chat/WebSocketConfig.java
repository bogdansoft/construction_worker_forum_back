...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
     ...
     *
     * @param config message broker options
     */
    @Override
     ...
     * This endpoint is used by the client to connect to the STOMP server.
     *
     * @param registry contract for registering STOMP over WebSocket endpoints
     */
    @Override
